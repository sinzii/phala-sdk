...
export interface VersionedPhalaApi<Rv extends RpcVersion> extends GenericSubstrateApi<Rv> {
 ...
 * @specVersion: 1270
 **/
export interface PhalaApi {
  legacy: VersionedPhalaApi<RpcLegacy>
  v2: VersionedPhalaApi<RpcV2>
}
